            ...
            <div class="form-container mx-auto animate__animated animate__fadeInUp">
                            ...
                            <tbody>
                                @foreach($budgets as $budget)
                                    <tr class="text-gray-900 dark:text-gray-300" data-id="{{ $budget->item_id }}">
                                        ...
                                        <td class="px-4 py-2 border-b border-gray-300 dark:border-gray-600 text-center">{{ $budget->item_name }}</td>
                                        <td class="px-4 py-2 border-b border-gray-300 dark:border-gray-600 text-center">{{ $budget->quantity }}</td>
                ...
                <div class="p-4 button-container">
                    <button type="button" class="cancel-btn shadow-lg">
                        <a href="{{ route('budget.create') }}">Back</a>
                    </button>
                </div>
            </div>            
